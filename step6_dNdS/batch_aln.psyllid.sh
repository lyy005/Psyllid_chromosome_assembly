for i in *.cds.fasta
#for i in 1.cds.fasta 2.cds.fasta 3.cds.fasta 4.cds.fasta 5.cds.fasta
do
 #echo $i
 ...
 /stor/work/Ochman/yli19/projects/aphid_genome/step9_paralogs/KaKs_Calculator/KaKs_Calculator2.0/bin/Linux/KaKs_Calculator  -i $i\.GBlocks.fas.pw.axt -o $i\.kaks &
done
